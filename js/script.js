...
arrayExample.forEach((letter, index) => {
  console.log(letter + '-' + index);
});

const numbersEx = [6, 3, 7, 1, 2, 4];

//const areAllEven = numbersEX.every(number => number % 2 === 0);
//console.log(areAllEven);

const areSomeEven = numbersEx.some(number => number % 2 === 0);
console.log(areSomeEven);

const firstEven = numbersEx.find(number => number % 2 === 0);
console.log(firstEven);

const firstEvenIndex = numbersEx.findIndex(number => number % 2 === 0);
console.log(firstEvenIndex);

numbersEx.sort((a, b) => b - a);
console.log(numbersEx);

const names = ['adrian', 'Angel', 'Laura', 'Carlos', 'César'];
names.sort((a, b) => a.localeCompare(b));
console.log(names);

//const total = numberEx.reduce((total, number) => total + number);
//console.log(total);
